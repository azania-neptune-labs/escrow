...
<head>
  ...
  <title>Nas-Escrow dashboard - Add a message</title>
  ...
  <section id="container" class="">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu active">
            ...
            <ul class="sub">
              <li class="active"><a class="" href="add_message.php">Write one</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-pencil"></i> Messages</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-pencil"></i>Send a message</li>
            </ol>
          </div>
        </div>
