...
<head>
  ...
  <title>Azania Nas Escrow dashboard</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo">Azania Nas ESCROW <span class="lite">Control Panel</span></a>
      <!--logo end-->
	...
	<div id="errors"></div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count" id="pendingEscrowsStat">0</div>
              <div class="title">Unfinished Escrows</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count" id="receivedEscrows">0</div>
              <div class="title">Refunded/Rejected Escrows</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              ...
              <div class="count" id="startedEscrows">0</div>
              <div class="title">Disputed Escrows</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <i class="fa fa-thumbs-o-up"></i>
              <div class="count" id="completedEscrows">0</div>
              <div class="title">Completed Escrows</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Initiate escrow</div>
              ...
              <div class="panel-body">
                ...
                <div class="padd">
                      ...
                      <div class="form-group">
                        <!-- Buttons -->
                        <div class="col-lg-9">
                            <button type="button" onclick="window.location.href='initiate_escrow.php'" class="btn btn-primary">Click here to initiate a <strong>NEW</strong> escrow transaction</button>
                        </div>
                      </div>
        ...
        <div class="row">
          <div class="col-lg-6 portlets">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Unread Messages</div>
                <div class="clearfix"></div>
              </div>
              ...
              <div class="panel-body">
                ...
                <div class="padd sscroll">
                  ...
                  <ul class="chats" id="unreadMessagesPanel">
        ...
        <div class="row">
          <div class="col-md-6 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><strong>Transactions Calendar</strong></h2>
          ...
          <div class="col-md-6 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Send a message</div>
                <div class="clearfix"></div>
              </div>
              <div class="panel-body">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal">
                      ...
                      <!-- Cateogry -->
                      <div class="form-group">
                        <label class="control-label col-lg-2">Escrow transaction</label>
                        <div class="col-lg-10">
                            <select class="form-control" id="escrowHashList">
                              <option value="">Choose an escrow transaction</option>
                            </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-offset-2 col-lg-9">
                            <button type="button" onclick="sendMessage($('#messageContent').val(), $('#escrowHashList').find(':selected').val())" class="btn btn-primary">Send</button>
